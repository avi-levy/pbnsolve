...
OBJ= pbnsolve.o read.o read_xml.o read_bw.o read_grid.o dump.o puzz.o grid.o \
	line_lro.o job.o solve.o gamma.o http.o clue.o merge.o exhaust.o
...
testline: testline.c line_lro.o read.o dump.o grid.o merge.o job.o read_xml.o \
	...
	merge.o job.o read_xml.o puzz.o clue.o $(LIB)

TARBALL= README CHANGELOG pbnsolve.html pbn_fmt.html Makefile \
